...
import { ShieldAlert, RotateCw, Home, MailWarning, Ban } from "lucide-react";

// Map NextAuth error codes
const ERROR_MAP: Record<string, { title: string; message: string; icon: any }> = {
  ...
  OAuthCallback: {
    ...
    message: "Could not receive the response from the authentication provider.",
    icon: RotateCw,
  },
...
export default async function AuthErrorPage(props: {
  ...
  const { title, message, icon: Icon } = ERROR_MAP[error] || ERROR_MAP.Default;
